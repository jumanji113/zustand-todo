    ...
    return (
        <div className={styles.inputTask}>
            <label className={styles.inputTaskLabel} htmlFor="">
                <input type="checkbox" disabled={isEditMode} checked={checked} className={styles.inputTaskChekbox}
                    onChange={(e) => {
                ...
                {isEditMode ? (
                    <input ref={editTitleInputRef} value={value} onChange={(e) => { setValue(e.target.value) }} onKeyDown={(e) => {
                        if (e.key === 'Enter') {
                            onEdited(id, value);
                            setIsEditMode(false);
                        }
            ...
            {isEditMode ? (<button aria-label='Save' className={styles.inputTaskSave} onClick={() => {
                onEdited(id, value);
                setIsEditMode(false);
